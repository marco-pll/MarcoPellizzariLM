...
for i in days_selected:
    ...
    for j in range(0,reps):
        ...
        storia = model_nn.fit(x = x_train, y = y_train, batch_size = 600, epochs = 1000, validation_data=(x_val,y_val), verbose =0, 
    ...
    model_nn.fit(x = x_train, y = y_train, batch_size = 600, epochs = (math.floor(epoche_best/3)+1), validation_data=(x_val,y_val), verbose =0)
